...
class _ViewPageState extends State<ViewPage> {
  ...
  Consumer<Control>(
    builder: (context, value, child) {
      return ProfilePage(image: value.profile['data']['image'], name: value.profile['data']['name'], emailorphone: value.profile['data']['email'],);
    }
  ),
  SupportPage(),
  FavoritesPage(),
  ...
  Widget build(BuildContext context) {
    return Consumer<Control>(
      ...
      child: Row(
        ...
        ? ProfilePage(image: value.profile['data']['image'] ?? Assets.imagesElprofile, name: value.profile['data']['name'], emailorphone: value.profile['data']['email'],) : Center(child: CircularProgressIndicator()),
              SupportPage(),
              FavoritesPage(),
              NotificationsPage(),
              HomePage(),
